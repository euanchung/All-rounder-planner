...
await build({absWorkingDir:process.cwd(),entryPoints:['./src/campus-app.js'],outfile:'dist/src/campus-app.js',tsconfigRaw:{},bundle:true,format:'esm',minify:true,define:{__AUTH_URL__:JSON.stringify(process.env.NEON_AUTH_BASE_URL)}});
