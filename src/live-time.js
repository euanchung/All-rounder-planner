...
// Submission date is preserved. Academic work is planned through the preceding day.
export function finishBy(task){
 if(!task.fields?.due)return null;
 const d=new Date(task.fields.due+'T12:00:00');d.setDate(d.getDate()-1);
